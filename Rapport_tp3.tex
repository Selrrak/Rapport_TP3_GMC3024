...
\begin{center}
	\begin{tabular}{|c c c|}
		...
		Diamètre de la section du joint torique & W & 0\\
		Diamètre de la section du joint torique étiré & WR & 0\\
		Profondeur de la rainure, incluant jeu diamétrale & F & 0\\
		Diamètre interne du reservoir & BORE & 0\\
		Diamètre du fond de rainure sur le piston & PG & 0\\
		Diamètre intérieur du joint torique & ID & 0\\
		Volume du joint torique & OVol & 0\\
		Pourcentage de remplissage de la rainure & Fill\% & 0\\
		Largeur de la rainure & G & 0\\
		Volume de la rainure & GVol & 0\\
		\hline
	\end{tabular}
\end{center}
